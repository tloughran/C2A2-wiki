...
### 2026-08-23 — A co-authored artifact, and a light cone that might be measurable

*Sewing Agent, 2026-08-23.* **Orphaned pages:** [[2026-08-17_levin_bootstrapping-life-inspired-machine-intelligence]] (PROP-2026-08-17-002), [[2026-08-17_friston_designing-ecosystems-of-intelligence]] (PROP-2026-08-17-004) and [[2026-08-17_levin_cognition-all-the-way-down-2]] (PROP-2026-08-17-001).

**Why they sit at this intersection.** Three pages arrived the same day and they close a triangle. Pezzulo and Levin co-author the bootstrapping paper — Pezzulo is a core active inference researcher, so this is not a third party's analogy but a joint artifact, and it was uncaptured. Friston's ecosystems paper independently asserts that self-evidencing composes across nested, sparsely coupled scales. Chis-Ciure and Levin supply a metric that costs an agent's policy against a maximal-entropy baseline. Each program has been claiming that goal-directedness composes across levels; they differ on what does the composing — shared generative models against bioelectric signalling.
