SEARCH-FOR-PRESUMPTION-184:
  ...
  Sources:
    1. Wang (2011) 'Transfer Learning by Structural Analogy' — structural-alignment rule transfer succeeds when source and target share relational structure; coding-rules and vault-rules share substantial structure (both are operational disciplines).
    2. Gentner & Markman (1997) — structural mapping is sufficient when the analogy is genuine; corollary-on-divergent-rules is the canonical pattern.

  Strength of support: Weak

  Summary: Some literature supports the transferability of operational rules when relational structure is preserved. Three corollaries (Rules 5, 8, 9) handle the known divergence points. The remaining 9 rules — being more general (e.g. simplicity, surgical changes, fail loud) — are plausibly more domain-general.

  Caveats: Plausibility of transfer is not the same as audited transfer. The presumption names the gap (no audit performed) honestly.
...
SEARCH-FOR-PRESUMPTION-184 (RE-TRIGGER cycle 1):
...
SEARCH-FOR-PRESUMPTION-184 (RE-TRIGGER cycle 3):
