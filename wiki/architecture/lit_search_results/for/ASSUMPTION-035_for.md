...
SEARCH-FOR-ASSUMPTION-035 (RE-TRIGGER cycle 3):
  ...
  PROVENANCE:
    Origin: 14a
    Chain: [14a→15a,15b→15c→15d→15a,15b→15c→15d→15a,15b→15c→15d→15a,15b→15c]
    Original item: ASSUMPTION-035
    Item type: ASSUMPTION
    Transform at each step:
...
SEARCH-FOR-ASSUMPTION-035 (RE-TRIGGER cycle 4):
