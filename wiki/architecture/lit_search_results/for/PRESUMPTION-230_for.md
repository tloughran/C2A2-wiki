...
SEARCH-FOR-PRESUMPTION-230 (RE-TRIGGER cycle 3):
  ...
  Recommendation: refreshed; carry forward prior recommendation (refreshed; carry forward prior recommendation (PARTIALLY-SUPPORTED (only when the render layer is behavior-neutral)))
