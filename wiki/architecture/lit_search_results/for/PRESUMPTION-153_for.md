...
SEARCH-FOR-PRESUMPTION-153 (RE-TRIGGER cycle 2):
  ...
  Evidence-trajectory note (security cluster): 2026 passwordless-auth guidance continues to favor phishing-resistant passkeys over magic-link/OTP surfaces; no NEW supporting evidence that signed-link integrity ALONE suffices surfaced this cycle.
