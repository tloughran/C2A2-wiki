...
SEARCH-FOR-PRESUMPTION-219 (RE-TRIGGER cycle 1):
  ...
  Recommendation: refreshed; carry forward prior recommendation (PARTIALLY-SUPPORTED (at current volume only))


---

SEARCH-FOR-PRESUMPTION-219 (RE-TRIGGER cycle 3):
  ...
  Recommendation: refreshed; carry forward prior recommendation (refreshed; carry forward prior recommendation (PARTIALLY-SUPPORTED (at current volume only)))
