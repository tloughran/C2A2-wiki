SEARCH-FOR-ASSUMPTION-202:
  ...
  Sources:
    1. Sporns, O. (2010). "Networks of the Brain." — Long-range association fibers integrate functionally segregated modules; integration/segregation is a core, measurable property.
    2. Bullmore & Sporns (2009). "Complex brain networks," Nat Rev Neurosci. — Graph measures (global efficiency, participation coefficient) operationalize cross-module integration.
    3. Newman, M. (2006) community structure. — Modules + inter-module links is a general, transferable formalism.
  ...
  Caveats: Support is for the brain case and graph integration in general; transfer to a curated narrative graph is the open question (PRESUMPTION-221), and the corollary needs a defined, resolution-stable integration measure.
...
SEARCH-FOR-ASSUMPTION-202 (RE-TRIGGER cycle 1):
...
SEARCH-FOR-ASSUMPTION-202 (RE-TRIGGER cycle 3):
