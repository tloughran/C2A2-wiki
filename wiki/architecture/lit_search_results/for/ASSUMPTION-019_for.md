SEARCH-FOR-ASSUMPTION-019:
  ...
  Sources:
    1. ResearchTrends, 2024. "A bibliometric perspective on Kuhnian paradigm shifts" — Direct analysis of bibliometric methods for detecting paradigm shifts.
    2. ResearchGate, 2015. "The emergence of plate tectonics and the Kuhnian model of paradigm shift: A bibliometric case study" — Plate tectonics example shows paradigm-shifting ideas remain bibliometrically invisible during emergence.
    3. Stanford Encyclopedia of Philosophy, ongoing. "Thomas Kuhn" — Comprehensive treatment of paradigm shift concept including delayed recognition.
    4. Springer Nature Biology & Philosophy, 2018. "Kuhnian revolutions in neuroscience" — Application of Kuhnian framework showing tool limitations delay detection.

  Strength of support: Strong

  Summary: Kuhnian paradigm shift theory predicts literature sparsity during genuine paradigm emergence. The plate tectonics case study demonstrates empirically that shifts are bibliometrically invisible during emergence. Post-hoc bibliometric reconstruction is easier than real-time detection. Literature absence is consistent with paradigmatic emergence, not evidence against it.

  Caveats: Absence could also indicate dead-end or search failure. Modern pre-print infrastructure may accelerate visibility. Paradigm shift concept itself contested. Retroactive identification requires decades of hindsight.

  Recommendation: SUPPORTED

---

SEARCH-FOR-ASSUMPTION-019 (RE-TRIGGER cycle 1):
...
SEARCH-FOR-ASSUMPTION-019 (RE-TRIGGER cycle 2):
