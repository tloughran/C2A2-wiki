SEARCH-FOR-ASSUMPTION-066:
  ...
  Sources:
    1. Wolfram, S. (2002) "A New Kind of Science" + (2020) Wolfram Physics Project + (2023) "What Is ChatGPT Doing..." — Wolfram explicitly frames computational irreducibility and the Ruliad as primitives that *philosophy and physics should adopt*, not as borrowings from existing philosophy.
    2. Wolfram (2021) "The Concept of the Ruliad" essay — explicitly frames the ruliad as a foundational ontological notion that prior philosophy did not articulate; this is method-export language.
    3. Reception literature on Wolfram (e.g., Bringsjord 2008; Israeli & Goldenfeld 2004) — typically reads Wolfram as exporting computational primitives into domains that previously used different methods.
    4. Computational-emergence literature (Holland 1998; Mitchell 2009 "Complexity") — the wider tradition of which Wolfram is part is generally read as exporting computation as a primitive into other fields.

  Strength of support: Moderate

  Summary: Wolfram's own framing and the secondary reception literature both support the claim that he treats his project as method-export — taking computation/computational-irreducibility/ruliad as primitives and pushing them into philosophy, physics, and beyond. The literature does not typically read him as method-importing from analytic philosophy.

  Caveats: (a) Some critics (see 15b) read Wolfram as importing from physics-philosophy without acknowledgment; (b) export-vs-import is a coarse binary that may understate Wolfram's actual entanglement with mathematical and computational philosophy.

  Recommendation: PARTIALLY-SUPPORTED (the export framing fits Wolfram's self-description and dominant reception)


---

SEARCH-FOR-ASSUMPTION-066 (RE-TRIGGER cycle 1):
...
SEARCH-FOR-ASSUMPTION-066 (RE-TRIGGER cycle 2):
...
SEARCH-FOR-ASSUMPTION-066 (RE-TRIGGER cycle 3):
