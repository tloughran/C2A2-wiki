...
Q.63–64 take up the **marriage debt** (debitum) — the mutual conjugal obligation drawn directly from 1 Corinthians 7. Aquinas, following Paul, makes the striking claim that the debt is *mutual and equal*: "the husband does not have power over his own body, but the wife; and likewise the wife does not have power over her own body, but the husband" (1 Cor 7:4). Neither spouse may unilaterally withhold; each has, in the conjugal matter, ceded sole self-possession to the other, and the obligation runs symmetrically. In a deeply hierarchical text, this is a moment of arresting equality. The contemporary version: **what is symmetric mutual self-giving, structurally — and why might it be the paradigm case of two limited perspectives forming a real loving unity?**

## Problem

The shared inquiry-problem is **the structure of complete mutual self-gift**. The debt is not a transaction between two self-possessing individuals; it is the formalization of a state in which each has *handed over* sole authority to the other, symmetrically. Aquinas (and Paul) need this to be a genuine mutuality — not one party's possession of the other, but a reciprocal cession that constitutes a shared authority over the one flesh. The contemporary sciences of coupled agency face the parallel: the deepest, most stable coupling between two agents is *symmetric* — each conditions on and is conditioned by the other equally, so that control over the joint state is genuinely shared rather than held by one node. Asymmetric coupling produces a master-and-instrument; symmetric coupling produces a *we*.
...
This is the article in which the central theme is least forced and most fully present. The project's claim is that loving unity — the goal toward which limited perspectives compute — is achieved when each perspective gives itself wholly to the other without being erased. The marriage debt is that claim in its most concrete human form: each spouse cedes sole self-possession to the other, symmetrically, and from that mutual self-gift a real one-flesh unity arises in which neither perspective is dissolved. 1 Cor 7:4 is, in this project's terms, a small scripture of the eschaton — the many no longer belonging only to themselves, held in a unity of love.
...
Q.65–66 (tomorrow) close this stretch with **polygamy and bigamy** — whether plural marriage was ever lawful — which presses directly on the symmetry established here: if complete mutual self-gift is symmetric and total, can it be divided among several? Open thread: the symmetry argument developed here is the natural premise for tomorrow's question, and the two syntheses should be read as a pair.
