...
last_qc_at: "2026-08-07T02:30:25"
...
Aquinas asks whether the saints' happiness is greater after the resurrection (Q.93) and how the blessed stand toward the damned (Q.94). The first answers gently: beatitude grows not in intensity but in *extent*, overflowing onto the risen body; the "many mansions" are degrees of glory tracking degrees of charity, since the light of glory itself admits of degrees. The second is the hardest passage in the whole Supplement. The blessed *see* the sufferings of the damned (contraries are more conspicuous side by side, so the saints render "more copious thanks"); they do *not* pity them (there is no sorrow in heaven, and pity would run contrary to divine justice); and they rejoice in the punishment — *indirectly*, in the order of divine justice and their own deliverance, never directly in the suffering itself.

The contemporary parallel has to do two things here: take seriously what is structurally right about *degrees of glory*, and mark clearly where the synthesis-in-progress *parts company* with Aquinas on the relation to the lost.

## Problem

The shared inquiry-problem is **whether differentiation survives perfection** — whether, when agents reach their end, they become uniform or remain distinct — and, downstream, **what the perfected owe to those who are not.** Aquinas's answer to the first is firmly that distinction persists: heaven is not homogeneous; mansions differ by charity. His answer to the second is the medieval one, and it is where a contemporary reading must be honest about disagreement.
...
Q.93 is the theme's quiet vindication: individuation is not the enemy of beatitude but its very texture — the saints differ, and the difference is their charity. Q.94 is the theme's hardest test: does "every limited perspective contained in the whole" mean every perspective, or only the saved? Aquinas says only the saved, and lets their joy be heightened by the others' loss. The synthesis-in-progress cannot follow him there without contradicting its own telos, so it parts company — and names the parting as a wager made under limitation, the proper posture of agents who "perceive more of the whole" only partially and need guidance from those who perceive more.
...
Today differentiation is affirmed and the relation-to-the-damned is where the synthesis diverges; tomorrow (Q.95-96) turns to the *gifts and crowns* of the blessed — the dowries and the aureoles — which makes differentiated reward its explicit theme and, in the "doctor's crown" for those who teach truth to others, touches this project's own reason for being. Open thread flagged: the universalist divergence here deserves a standalone bridge essay weighing Rohr/Wright against the retributive tradition, marked speculative throughout.
