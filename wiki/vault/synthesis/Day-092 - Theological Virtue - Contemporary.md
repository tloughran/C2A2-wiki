...
karpathy_wiki_sources:
  ...
  - "levin/wiki.md (morphogenetic teleology, multi-scale agency, scaffolding)"
  - "friston/wiki.md (active inference, hyperpriors)"
  - "master/cross_program_index.md (CROSS-04 grace-as-scaffolding)"
...
Levin (morphogenetic teleology, Levin 2022 and related work) shows that biological agency is **scaffolded across scales** — individual cell behavior is shaped by morphogenetic fields that the cell itself cannot construct from its own internal state. This is the empirical analogue of "infusion": competence delivered from a scale the agent doesn't have access to. Empirically firm.

Friston (active inference, Friston et al. 2017 onward): some priors in a hierarchical generative model are *hyperpriors* set by the developmental and cultural context; the agent inherits them but did not infer them. This is the technical formalization. Empirically robust at the modeling level.
...
- **Faith** = the agent's stable second-personal disposition toward the conscious whole. Computationally: a hyperprior on "the relationship-network I am embedded in is real and trustworthy." Stump's second-personal reading is the philosophical engine; Friston's hyperpriors give the formal shape.
...
- **CROSS-04 (master index, grace-as-scaffolding):** Tom's Synergistic Coil — one resource (cross-scale scaffolding) solves Ps in theology (infusion), biology (morphogenesis), and computational cognitive science (hyperpriors).
