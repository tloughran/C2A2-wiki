---
day: 27
video_id: dtBR6GIHAf0
url: https://www.youtube.com/watch?v=dtBR6GIHAf0
title: Angelic Bodies
summa_ref: Prima Pars, Q.51 + Q.52
duration_seconds: 812
word_count: 2154
raw_asr_word_count: 2154
length_tier: medium
segment_count: 306
caption_kind: asr
language: en
...
---
# Day 27 — Angelic Bodies

> Episode: <https://www.youtube.com/watch?v=dtBR6GIHAf0>
> Series: *Summa in a Year* by Austin Habash. Day 27 of 308.
> Summa reference: *Prima Pars, Q.51 + Q.52*
...
### Q.51 — The angels in comparison with corporeal things

**Article 1 — Whether the angels have bodies naturally united to them**

[00:00:47] we go article one whether the angels have bodies naturally United to them the answer seems obvious but the question is worth asking because angels are intelligent and as far as we can see down here everything intelligent relies upon the body to drive that intelligence as we've said before the blind man he doesn't know blue because he's never seen it with his body or looked at from the perspective of Education we teach a child what Circle means what a circle is by placing various different colored or textured or sized circles in front of

[00:01:19] them calling them all circles and then allowing the child to grasp what they have in common namely being a circle they understand what a circle is in both of these scenarios our knowledge of color or particular shape is rying upon the senses it's ryant upon the body so the body is required for our intelligence but according to Aquinas this is merely due to our imperfection our lower grade kind of intelligence as compared to the angels when he writes the angels have not bodies naturally United to them it belongs to the human

[00:01:51] soul to be United to a body because it is imperfect not having the fullness of knowledge in its own nature but acquiring it from sensible things through the bodily senses as will be explained later on in the intellectual nature there are some perfectly intellectual substances which do not need to acquire Knowledge from sensible things and this we call angels and we will treat on Angelic knowledge versus human knowledge more specifically in the

[00:02:20] Summa to come
...
[00:04:22] article three whether the Angels exercise functions of life in the bodies assumed when the Angels assume a body does that body eat and drink in such a way that the food is digested like we do with our own body St Thomas says no because of what has been mentioned before on how those bodies are made what they are comprised of he will also remind us that these Powers the vegetative power the power to grow and to receive nutrition the sensitive powers like sight smell Etc they follow upon the form or the essence of the
...
### Q.52 — The angels in relation to place

**Article 1 — Whether an angel is in a place**

question 52 the angels in relation to place what then after all is Place Aristotle asks in the physics he then says we assume then this Maxim place is what contains that of which is in the place place is no part of the thing if

[00:06:28] one takes that coupled with the comment by Aquinas on Aristotle's physics which is now just as Place must be something over and above the contained body so it must be something other than the containing body due to the fact that place remains immobile while the containing body and everything in it can be changed about we can arrive then at Aristotle's definition of place which is the immobile boundary of that which contains first first to designate proper
...
[00:08:23] to speak to briefly as well
...
[00:09:59] his actions to a particular thing or a particular place now that place according to one commentator can be as large as a candle or a continent but is always considered as one particular thing or place here we may be led to contemplate that hierarchy within the angels for a distinction in the scope of the various hierarchies or Angels influence on Earth because we do see certain Angels or princes being designated in scripture as to preside

[00:10:32] over areas as large as an Empire we see that in Daniel 7 where the angel says to Daniel the prince of the kingdom of Persia with stirred me 21 days but Michael one of the chief princes came to help me and so I left him there with the prince of the kingdom of Persia we will discuss the hierarchy of angels around

[00:10:53] question 108 of this volume

**Article 3 — Whether several angels can be at the same time in the same place**

article 3 whether several angels can be at the same time in the same place Aquinas responds there are not two souls in the one body therefore for like reason there are not two angels in the same place like the soul which is the most proximate closest affecting or actualizing cause of the matter which is your body affecting the material of your body in a sufficient and complete kind

[00:11:24] of way there is no need for another soul that would be doing the same thing at the same time and there cannot be another in the same way if an angel is affecting a place it is affecting that place as concerns its particular effect in an exclusive and sufficient kind of way yet on the other hand multiple Angels may be having multiple and diverse effects on the same thing and in this way be said to be in the same place think of the demon-possessed man in Mark 5 who cries out that he is possessed by
...
- Q.51 a.1 reads angels as "perfectly intellectual substances which do not need to acquire knowledge from sensible things" — defining angels by *not needing the sensory loop*. This is the cleanest contrast against the human knower-with-body picture: human cognition is *deficient* relative to angelic in the medieval reading. Bridge: Hawkins HTM is structurally interesting here — HTM models human cognition as compression over sensory streams; an HTM-like architecture that *didn't* need the sensory stream would resemble Aquinas's angel in computational shape. Speculative but suggestive.
- Q.51 a.2's air-condensation account of how angels "assume bodies" is the most empirically vulnerable part of the day's content — Aquinas inherits this from late-antique angelology, and Habash flags it as Aquinas's own conjecture rather than dogma. The synthesis should mark this as honest theological speculation, not as a load-bearing claim, and the contemporary translation is *not* atmospheric-physics but mind-monism's *alter-can-pattern-substrate-locally* — a structural-philosophical replacement rather than a physical-mechanical one.
- Q.51 a.3 strictly limits angelic "bodily" function to *appearance*, not real eating or speaking — Tobias is the canonical anchor ("when I was with you I seemed indeed to eat and drink but you were seeing a vision"). The angelic body is *for the perceiver*, not *of the angel* — which is exactly Hoffman's interface-theory structure: the body is the perceiver's interface-representation, not the perceived's substance. Hoffman PRS-03 the structural bridge.
- Q.52 spends most of its time on what *place* means — Aristotle's "immobile boundary of that which contains" is read through Aquinas's commentary, and the key technical move is the distinction between *being in a place by dimensive quantity* (us) and *being in a place by application of power* (angels). This is the spine of the day's metaphysics: place-as-coupling-scope rather than place-as-spatial-coordinate. Bridge: Hoffman on space as interface (the agent is "where its causal reach goes," not "where its body sits"); Wolfram on locality as causal-network proximity rather than spatial-coordinate proximity.
- Q.52 a.2's *an angel acts in one place at a time* — finite power applied to a definite scope — is essentially the medieval doctrine of agentive bandwidth. Friston's account of a Markov-blanket-bounded agent has the same structural shape: the agent's free-energy minimization happens *within its blanket*, not across the universe. Speculative as a direct mapping but structurally the same constraint.
- Q.52 a.3's *several angels can be in the same place if their effects are different* — the Mark 5 Legion example — preserves additivity of effects without competing for the same effect-channel. The boat-rowing analogy ("no one man's strength sufficient; all together as one mover") is Aquinas's combinatorial-effect intuition. Friston-Fredrickson CROSS-010 (joint substrate-level action) is the closest contemporary cousin.
