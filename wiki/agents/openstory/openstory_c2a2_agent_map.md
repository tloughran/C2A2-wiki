...
|---|---|---|---|
| `c2a2-agent-levin-friston` | Mon 03:04 | 01_levin, 02_friston | 3 sessions (→06-08) |
| `c2a2-agent-hawkins-hoffman` | Tue 03:04 | 04_hawkins, 03_hoffman | 2 (→05-05) |
| `c2a2-agent-mcgilchrist-kastrup` | Wed 03:07 | 05_mcgilchrist, 11_kastrup | **0** |
| `c2a2-agent-stump-fredrickson` | Thu 03:04 | 07_stump, 06_fredrickson | **0** |
| `c2a2-agent-carroll-arkanihamed` | Fri 03:07 | 08_carroll, 09_arkanihamed | **0** |
| `c2a2-agent-wolfram` | Sat 03:07 | 10_wolfram | 2 (→05-05) |
| `c2a2-agent-wright-rohr` | Sun 03:13 | 18_wright, 19_rohr | **0** |
...
|---|---|---|---|
| `c2a2-self-awareness-daily` | daily 23:37 | 14a_assumption_extractor, 14b_presumption_detector | 5 |
| `c2a2-lit-search-pipeline` | daily 00:39 | 15a_lit_search_for, 15b_lit_search_against, 15c_net_evaluator | 5 |
| `c2a2-periodic-monitor-weekly` | Sun 03:33 | 15d_periodic_monitor | **0** |
| `c2a2-deferred-action-monitor` | daily 02:33 | 16_deferred_action_monitor | **0** |
| `c282-wiki-agent-daily-run` ⚠️ | daily 04:34 | 12_master_C2A2 (orchestrator) | 8 |
| `c2a2-wiki-janitor-weekly` | Sun 05:53 | — (SKILL.md only) | **0** |
| `c2a2-sewing-agent-weekly` | Sun 04:38 | — (SKILL.md only) | **0** |
| `c2a2-prs-connectome-weekly` | Sun 07:39 | — (SKILL.md only) | 1 |
...
| `summa-2026-daily-batch` | daily 05:02 | SKILL.md | 1 |
| `summa-2026-nightly-verification` | daily 23:06 | SKILL.md | **0** |

## Bridge agents (category: bridge)

| taskId | Schedule | OpenStory capture |
|---|---|---|
| `morning-walk-cowork-handoff` | M–F 09:10 | 4 |
| `c2a2-morning-chat-scrape` | daily 08:52 | 4 |
| `c2a2-evening-cowork-to-chat` | daily 18:38 | 4 |
...
| `scheduler-health-check` | daily 07:09 | 1 |
| `supabase-c2a2-keep-warm` | daily 06:35 | 1 |
| `weekly-agent-ecosystem-report` | Sun 22:39 | **0** |
| `connector-health-weekly` | Sun 06:19 | **0** |
| `weekly-claude-projects-backup` | Sun 23:01 | **0** |
