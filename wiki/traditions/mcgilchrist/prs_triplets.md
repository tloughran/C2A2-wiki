# Iain McGilchrist — PRS Triplets
*Maintained by the Iain McGilchrist Agent | Last updated: 2026-04-05*
*Source: Resurrecting Civility HTML Document Explorer (RC Pilot) — narrative sections pp.284–286*
...
PRS-01:
  Label: P1 (Text, pp.284–285) — Hemispheric asymmetry and cultural impoverishment
  Problem: Modern Western culture increasingly operates in a left-hemisphere mode — abstraction, fragmentation, manipulation — at the expense of right-hemisphere holistic, relational engagement with reality
  Resource: The Master and His Emissary (McGilchrist 2009): empirical neuroscience of hemispheric asymmetry; the right hemisphere as primary, the left as parasitic on what the right first discloses
  Solution: Cultural and philosophical recovery of right-hemisphere modes of attention: phenomenological, relational, embodied knowing prior to and founding analytical abstraction
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: High

PRS-02:
  Label: P2 (Text, pp.285–286) — Relational ontology lacking neurological grounding
  Problem: Conscious realism and tradition-based philosophy both emphasize relational ontology but lack neurological/empirical grounding for why relational perception is prior to analytic abstraction
  Resource: McGilchrist's neurological account: the right hemisphere's integrative attention discloses reality first; left hemisphere operations are parasitic on that prior disclosure
  Solution: McGilchrist's model provides the neurobiological substrate for relational ontology — grounding philosophical claims about the primacy of relation in empirical brain science
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: High

PRS-03:
  Label: P3 (Implicit) — Cross-tradition dialogue and hemispheric modes
  Problem: Mature engagement across intellectual traditions requires holding one's own framework lightly enough to genuinely inhabit another's — a capacity modern fragmented discourse systematically undermines
  Resource: McGilchrist's team/game distinction (as applied in RC Pilot): right-hemisphere team engagement vs. left-hemisphere game-rule analysis — two modes both needed for cross-tradition dialogue
  Solution: A model of dialectical engagement pairing right-hemisphere openness (inhabiting the whole of another tradition) with left-hemisphere analysis (identifying structural rules of disagreement) — the neurological basis for second-first-language learning
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-04:
  Label: P4 (Implicit) — Multi-agent integration and proof of concept
  Problem: Conscious realism posits that individual conscious agents integrate into higher-order agents, but the mechanism of that integration in human cognition is underdetermined
  Resource: McGilchrist's corpus callosotomy data: when hemispheres are severed, each operates as a separate conscious agent; when integrated, a single unified self emerges — empirical proof of conscious agent fusion
  Solution: Split-brain evidence supports Conscious Realism's mathematical claim that agent networks form higher-order agents — providing empirical grounding for a theoretical claim that had lacked it
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-05:
  Label: P5 (Implicit) — Attention as ontological act
  Problem: Contemporary epistemology treats attention as a cognitive function rather than an ontological act — missing that the mode of attending constitutes the kind of world that shows up
  Resource: McGilchrist's claim that attention is world-constituting: the mode of attention (right vs. left hemisphere) shapes not just what we see but what kind of world is disclosed
  Solution: A philosophy of attention as ontological action — compatible with Friston's precision-weighted prediction (attention as evidence weighting) and Hoffman's interface theory (attention as fitness-tuned perception)
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-06:
  Label: P6 (Implicit) — Embodied tradition formation
  Problem: Traditions transmit more than propositions — they transmit embodied skills, perceptual habits, and tacit knowledge that resist formalization; modern institutions systematically lose this
  Resource: McGilchrist's account of embodied cognition: right-hemisphere knowledge is skill-based, contextual, and person-involving — not merely propositional
  Solution: Tradition formation requires deliberate cultivation of right-hemisphere engagement: mentorship, shared practice, contextual immersion — not information transfer alone; implications for C2A2's tradition-accelerator design
  Date Added: 2026-04-05
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium
...
---
PRS-70:
  Problem: PRS-15 records modernity as *active* re-wiring, but its exhibits are drawn from media and education (screen-based learning, algorithmic media, bureaucratic rationalism), and the constructive institutional case at PRS-29/PRS-47 rests on Ralston College — the one institution McGilchrist chairs, which makes it advocacy rather than survey. Open question 4 ("what institutional practices cultivate right-hemisphere openness") has therefore never been answered in this wiki from a source in which McGilchrist discusses institutions in the plural and in the concrete, and in which he has no stake.
  Resource: The exhibit list offered in Hidden Forces Ep. 452 as the places left-hemisphere encroachment is visible — procedural formulation of diagnoses in modern medicine, process valued over outcome, the commodification of writing, rising depression, the policing of language, and the reverence for machine-like efficiency and profit maximisation.
  Solution: Converts "the metacrisis" from a diagnosis stated at the level of culture into six separately arguable and separately falsifiable claims about institutional practice: a reader who accepts four and rejects two has a sharper disagreement than one who simply doubts modernity. The medical exhibit is the load-bearing increment — *procedural diagnosis*, the physician working an algorithm rather than knowing a patient, is the first clinical instance recorded in this wiki, and it comes from McGilchrist's own discipline rather than from cultural criticism about it.
  Date Added: 2026-08-28
  Source: Diagnosing the Metacrisis: Reality & Meaning in Modern Life | Iain McGilchrist (Hidden Forces, Episode 452, recorded 2025-12-01); PROP-2026-08-14-011
  Confidence: Medium
  Evidence: The six domains are enumerated in the producer-written episode summary on hiddenforces.io as the places "we see it." **EVIDENCE GATE PARTIALLY OPEN:** the proposing agent retrieved and read the episode page, the recording date, the guest bio and the episode number, but did *not* hear the audio; the transcript, the Intelligence Report and the full-episode file are behind a Supercast paywall and render as "content locked." Nothing here is McGilchrist's quoted wording, and the assignment of these six exhibits to the *hemispheric* diagnosis specifically is the publisher's framing of his argument, not a transcribed formulation. Coded Medium on the house standard already set by PRS-61..PRS-69, which rest on published event descriptions. Do not raise to High, and do not quote any of the six phrases as McGilchrist's, without the paid transcript.

---
PRS-71:
  Problem: This tradition's positive prescription has been individual and attentional — attend differently, receive rather than grasp (PRS-20 spaciousness; PRS-36 personal formation by embodied intrinsic value). PRS-12 places community as the *transmission medium* of a tradition but not as a condition of the remedy itself. The prescription is therefore open to the charge that it asks each person to solve alone a problem the culture manufactures.
  Resource: Self-actualization framed as achievable only in the context of community and in service to others, paired with a claimed generational change of heart toward "a relational sense of meaning and purpose."
  Solution: Relocates the remedy from the individual's attentional discipline to the relational setting that makes that discipline available. The consequence is a change in the shape of open question 13: if the width of attention available to a person is set partly by the relational form of the community they inhabit, then "cognitive freedom" (PRS-65) is a property of a social arrangement and not only a psychological quantity — and the measurement target becomes the community rather than the person. That is the point at which Fredrickson's positivity resonance, which is already defined at the dyad rather than the individual, becomes a candidate instrument rather than a loose analogy.
  Date Added: 2026-08-28
  Source: Diagnosing the Metacrisis: Reality & Meaning in Modern Life | Iain McGilchrist (Hidden Forces, Episode 452); PROP-2026-08-14-011
  Confidence: Speculative
  Evidence: The episode summary states that the two discuss "the importance of self-actualization in the context of community and being in service to others" and McGilchrist's being inspired by a change of heart in younger generations toward "a relational sense of meaning and purpose." **EVIDENCE GATE OPEN on the generational claim:** whether McGilchrist offers any evidence for it beyond impression cannot be determined without the audio, which is paywalled. The re-framing of open question 13 in the third sentence of the Solution is this wiki's inference from the community framing, not something the summary attributes to McGilchrist. Speculative for both reasons; the generational claim must not be cited as an empirical finding.

---
PRS-72:
  Problem: The priority of metaphor and poetic language over literal propositional language is load-bearing throughout this program — PRS-57 makes metaphor-selection a first-order methodological act, and PRS-55 rests the in-principle irreducibility claim on the Zen argument. Yet across roughly 35 proposals the tradition holds no source in which McGilchrist is engaged *as a reader of poems* by interlocutors whose discipline is poetry rather than neuroscience, metaphysics, or cultural criticism. That is the one register in which the metaphor-priority claim faces an audience with no prior need of it.
  Resource: A confirmed appearance as guest on the Poetry Foundation's *Poetry Off the Shelf* (host Helena de Groot, published 2026-04-14, syndicated by Channel McGilchrist 2026-04-27), on Rip Van Winkle, the poet's brain, and "the real word for sunshine."
  Solution: Closes a documented gap in the reception record and extends the venue-type argument of PRS-23 and PRS-45 into the literary-critical register — the tradition's evidence for its own linguistic thesis has until now come entirely from venues that already grant the hemispheric frame. Records the item as dated and locatable so its content candidates can be retrieved rather than lost; if the "real word for sunshine" claim is what the title suggests, it is the smallest falsifiable unit this program's impoverishment thesis has ever been pinned to — a single lexical item a linguist could dispute without disputing the hemispheric programme.
  Date Added: 2026-08-28
  Source: A Handful of Dust — Iain McGilchrist on Rip Van Winkle, the poet's brain, and the real word for sunshine (Poetry Off the Shelf, Poetry Foundation, 2026-04-14); PROP-2026-08-14-012
  Confidence: Medium
