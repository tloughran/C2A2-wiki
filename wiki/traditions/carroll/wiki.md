...
12. **Is higher-level causal structure real or bookkeeping, when it is manipulable?** Pigozzi & Levin report that causal emergence in a pre-replicator catalytic medium not only predicts the onset of self-replication but responds to intervention — driving it up lengthens replicator persistence, driving it down reduces replicator abundance. That is the strong reading of emergence: a control knob, not a description. Poetic naturalism's deflationary account of emergence is the natural opposing position, and this is the sharpest available test case. *(added 2026-09-02, dispatched from PROP-2026-08-16-008)*
13. **Is the constraint mathematics places on physics *causal* or merely *descriptive*?** Levin states flatly that "physicalism has been dead for a long time" and that non-physical mathematical facts causally constrain physical outcomes. Poetic naturalism holds there is one world describable in many vocabularies, none introducing additional causal ingredients. Both parties accept that mathematics constrains physics; they disagree about the modality of the constraint. **Recorded as a tension, not a bridge — these are not compatible readings of the same evidence and should not be smoothed.** *(added 2026-09-02, dispatched from PROP-2026-08-14-001)*
...
Processed 3 source file(s); minted PRS-68 - PRS-78.
