# Michael Levin — PRS Triplets
*Maintained by the Michael Levin Agent | Last updated: 2026-04-03*
...
PRS-01:
  Label: P1 (Text, p.452) — Morphogenetic Control
  Problem: Organisms lack a mechanism for large-scale body-plan repair and regeneration in medicine
  Resource: Bioelectric circuits encode anatomical target states; membrane voltage as morphogenetic memory
  Solution: Construction of machinery for made-to-order biological morphogenesis, regenerative medicine, and cancer therapeutics through articulation of bioelectric circuitry
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: High

PRS-02:
  Label: P2 (Text, p.452) — Cancer as defection
  Problem: Cancer represents uncontrolled cell proliferation — defection from the body's cooperative morphogenetic community
  Resource: Bioelectric coherence — restoring cells to the body's collective morphogenetic field
  Solution: Cancer therapeutics targeting bioelectric field disruption rather than genetic mutations alone
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: High

PRS-03:
  Label: P3 (Text, pp.62–64) — Morphological attractor formalism
  Problem: No formal mathematical language exists for 'basins of morphological attraction' — the body's target states
  Resource: Free Energy / Least Action frameworks borrowed from physics and predictive coding neuroscience
  Solution: Formal modeling of morphogenetic goal-seeking as free energy minimization; Lagrangian paths for morphological attractors
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: High

PRS-04:
  Label: P4 (Implicit) — Cognition substrate
  Problem: Cognition is assumed to require neural substrates, leaving the agency of non-neural cells philosophically unaccounted for
  Resource: Bioelectric computation as substrate-independent cognition; xenobots as empirical proof of concept
  Solution: A generalised theory of basal cognition unifying cell, tissue, organ, and brain under a single framework of goal-directed information processing
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-05:
  Label: P5 (Implicit) — AI alignment via biology
  Problem: AI systems lack the multi-scale cooperative agency that biological systems achieve naturally
  Resource: Levin's model of collective intelligence in cell communities as template for multi-agent AI
  Solution: Bio-inspired architectures for AI alignment that encode cooperative goal-directedness at multiple scales, using morphogenetic principles
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-06:
  Label: P6 (Implicit) — Hard problem softened
  Problem: The hard problem of consciousness has no agreed scientific purchase
  Resource: Bioelectric memory and goal-directedness as empirical markers of primitive experience/agency
  Solution: A continuum model from cellular bioelectricity to human consciousness that dissolves the sharp divide between matter and mind
  Date Added: 2026-04-03
  Source: Resurrecting Civility — RC Pilot GPT Tome / Document Explorer
  Confidence: Medium

PRS-07:
  Label: P7 (PROP-2026-04-07-002) — Bioelectric reprogramming as therapeutic paradigm
  Problem: Current medicine treats disease by targeting DNA/hardware (genes, proteins) while ignoring the bioelectric "software" layer that coordinates cell behavior
  Resource: Bioelectric reprogramming — manipulating voltage patterns in cell networks to change their collective behavior without altering DNA
  Solution: A new therapeutic paradigm: treat cancer, birth defects, and aging by updating bioelectric instructions rather than genetic code — demonstrated in planaria, frogs, and early mammalian models
  Date Added: 2026-04-07
  Source: Tim Ferriss Show #849, Michael Levin interview (January 21, 2026)
  Confidence: High

PRS-08:
  Label: P8 (PROP-2026-04-07-002) — Cells as cognitive agents in anatomical morphospace
  Problem: The mechanism by which non-neural cells exhibit goal-directed behavior (cognition of cells) remains poorly understood by mainstream biology
  Resource: The concept of cells as cognitive agents navigating "anatomical morphospace" — using bioelectric signals as a proto-cognitive medium for storing and processing information about body form
  Solution: A framework that treats cell collectives as problem-solving agents, opening regenerative medicine to top-down (information-level) interventions rather than bottom-up (molecular) manipulation
  Date Added: 2026-04-07
  Source: Tim Ferriss Show #849, Michael Levin interview (January 21, 2026)
  Confidence: High
...
PRS-93:
  Problem: The peer-reviewed record preserves only finished, single-perspective manuscripts. The live argument among experts — where clarifications, objections and challenges actually do their work — has almost no mechanism for entering the citable record, and is lost by default at an unmeasured opportunity cost.
  Resource: "Conversation as publication" — a concrete, reusable editorial format: take a branched multi-author email chain, linearize it, edit it minimally so that it stays largely verbatim, list every participant as a middle co-author, give each light-edit rights over their own text, and put the result through peer review with a DOI.
  Solution: Demonstrates by instance that an email symposium among 33 thinkers can be made a citable, peer-reviewed artefact, and offers itself explicitly as a template rather than a one-off. This is the only genuinely Levin-voiced argument in the paper (see Evidence) and it is methodological, not biological: it is a claim about how inquiry should keep its own record. Read alongside PRS-91/PRS-92 it marks a distinct strand in the tradition — Levin acting on the infrastructure of inquiry rather than on its content.
  Date Added: 2026-08-29
  Source: Defining Life: A Conversation (Kofman, ..., Levin, *Organisms. Journal of Biological Sciences* 9(1), 11-47, doi 10.13133/2532-5876/19492, published 2026-07-08); PROP-2026-08-12-010
  Confidence: High
  Evidence: Abstract, read verbatim: "we here provide a minimally-edited (largely verbatim) transcript of the email chain among leading thinkers... It is our hope that this case study serves as an example for future papers, since the exchange of ideas among scientists is at least as interesting and valuable as formal scientific manuscripts written from a single perspective." Methods, verbatim: "Michael Levin and Karina Kofman compiled the text and linearized the numerous branches of replies as much as possible." Levin is corresponding author, so the first-person-plural claim is signed by him. **Load-bearing attribution finding, carried forward from the proposal: Levin contributes NO speaker turn in this paper.** A search of the full extracted text for a `Michael Levin:` speaker label — the format every other participant is given — returns zero matches. He appears only as corresponding author, co-compiler, a third-party reference inside Gentili's turn, and a reported private aside inside Newman's turn. His own three-sentence definition is said to be appended but no appendix block is locatable in the extracted text. Roughly two-thirds of the transcript body and the reference list were NOT read.
...
PRS-94:
  ...
  Solution: Reframes a century of definitional deadlock as a projection artefact rather than a factual disagreement, with the deflationary corollary that the definitional question is not worth answering and only the sub-processes are. Reber's objection (an observer-relative life-criterion presupposes a living observer, so is circular) and Miller's counter-position (life is binary in essence, continuous only relative to our instruments; endospores with no measurable metabolism for millennia as the test case) are preserved alongside it **unadjudicated** — which is the point of the artefact and is how this triplet should be read.
  Date Added: 2026-08-29
  Source: Defining Life: A Conversation; PROP-2026-08-12-010
  Confidence: Medium
  Evidence: All three turns read verbatim. Pavlic: "Metric is objective, but the threshold above which one infers that the metric is 'life' is observer relative"; "If you project a complex, multidimensional space onto a manifold with far lower dimensions, you are bound to have some residual error." Reber: "If the determination of whether something is alive is conditional on being 'observer relative' then the observer in this equation has to be alive to make said determination... I think I see a problem here." Miller: "Life is binary (i.e. an organism is alive or not), if we had the correct tools to make that measurement with deep precision, which we do not." **Confidence DOWNGRADED from the proposal's High to Medium on ingest, deliberately and against the card.** The card marked it High while its own attribution caveat says "none of this is Levin's voice." The quotations are High-confidence *as quotations*; as a claim held by this tradition they are not, because the tradition's namesake compiled the exchange rather than taking a position in it. Anyone reading this triplet as Levin's view is reading it wrong.
...
PRS-95:
  ...
  Resource: Gentili's proposed "Multiscale Chemistry": chemical systems manifesting self-organization at different spatial scales and multi-level causality under appropriate macroscopic thermodynamic forces, developed alongside Chemical Artificial Intelligence (CAI), in which the hardware/software distinction of conventional AI is merged into the "wetware" of reactive chemical solutions.
  Solution: Proposes a wet-chemistry route to testing whether multiscale competency is achievable without life — which, if it succeeded, would decide the definitional question empirically rather than lexically. This is the sharpest falsifiable consequence in the paper for the Levin program specifically, because multiscale competency is the program's own central claim (PRS-04, PRS-09, PRS-38, PRS-92) and here someone proposes to build a non-living instance of it.
  Date Added: 2026-08-29
  Source: Defining Life: A Conversation; PROP-2026-08-12-010
  Confidence: Medium
